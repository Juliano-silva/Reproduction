...
Open.addEventListener("click",function(){
    var Estado = getComputedStyle(Sidebar).display
    if(Estado == "none"){
...
var Backgrounds = localStorage.getItem("Background")

function Load(){
    document.getElementById("BodyBody").style.backgroundImage = `url(${Backgrounds})`
}
